...
function generateGenericNewsletter(query: string, frequency: string): Newsletter {
  ...
  return {
    ...
    sources: [
      { title: `${query} Industry Overview 2026`, url: "#", type: "Industry Report", views: "15.3K", trending: true },
      { title: `Market Analysis: ${query} Sector Trends`, url: "#", type: "Research Paper", views: "12.1K", trending: true },
      { title: `Investment Landscape for ${query}`, url: "#", type: "VC Analysis", views: "9.8K", trending: false },
      { title: `${query}: Technology Adoption Survey`, url: "#", type: "Survey Results", views: "7.5K", trending: false },
    ],
